const PT_DATA = {
  ...
  sections: {
    ...
    about: [
      ...
      'Bartira é graduada pela Trinity College Dublin (TCD) em &quot; MSc in Entrepreneurship &quot;, tendo como parte da sua pesquisa e dissertação de mestrado a necessidade de treinamentos de segurança alimentar no mercado Irlandês.Bartira também possui treinamento com certificação em "Advanced HACCP Design and Validation based on Risk Assessment(Level 6)" pelo QQI, Bacharel pela International College Dublin(ICD) - "BA(Honours) Business Studies" - em negócios e treinamento, com certificação pela School of Education - Trinity College Dublin(TCD) em "Mentoring Training".',
      '',
